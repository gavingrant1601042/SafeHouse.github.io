<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupZoomLink.aspx.cs" Inherits="SafeHouse.SetupZoomLink" %>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Set-Up Zoom Link</h3>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-xl-3 mb-4">
                   
                      <div class="form-group">
    <label for="exampleInputEmail1">Enter Zoom URL</label>
      <asp:TextBox ID="txtZoomURL" runat="server" class="form-control" placeholder="Zoom URL" ></asp:TextBox>
  </div>
                            <br />
                                       <asp:Button ID="btnZoomURl" runat="server" Text="Post Zoom Url" class="form-control" OnClick="btnZoomURl_Click"  />
                                     <asp:Button ID="txtZoomID" runat="server" Text="" class="form-control" OnClick="btnZoomURl_Click"  Visible="false" />
                            <hr />
                            <h3> Set Up Zoom </h3>
 <asp:GridView ID="gridViewZoomLink" runat="server" AutoGenerateColumns="False"  AutoPostBack="true" CellPadding="4" GridLines="None" CssClass="auto-style1" ForeColor="#333333" OnSelectedIndexChanged="gridViewZoomLink_SelectedIndexChanged">
                                <AlternatingRowStyle BackColor="White" />
                                <Columns>
                                    <asp:BoundField DataField="zoom_id" HeaderText="Zoom_Id" />
                                    <asp:BoundField DataField="zoom_url" HeaderText="Zoom URL" />
                            ...
                            <hr />
                              ...
                              <center><h4>Operations </h4></center>
                               <asp:Button ID="btnSetCurrent" runat="server" Text="Set Current Link" class="form-control" OnClick="btnSetCurrent_Click" /><br />
                                       <asp:Button ID="btnDeleteZoomLink" runat="server" Text="Update Zoom Link" class="form-control" OnClick="btnDeleteZoomLink_Click" style="height: 32px"  /> <br />
