<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TotalPendingRequest.aspx.cs" Inherits="SafeHouse.TotalPendingRequest" %>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Set-Up Total Pending Request</h3>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-xl-3 mb-4">
                   
                      <div class="form-group">
    <label for="exampleInputEmail1">Enter Total Pending Request</label>  
      <asp:TextBox ID="txtPendingRequest" runat="server" class="form-control" placeholder="Pending Request" ></asp:TextBox>
  </div>
                            <br />
                                       <asp:Button ID="btnPendingAmt" runat="server" Text="Post Pending Amount" class="form-control" OnClick="btnPendingAmt_Click"  />
                                     <asp:Button ID="txtPendingRequestID" runat="server" Text="" class="form-control"   Visible="false" />
                            <hr />
                            <h3> Pending Request </h3>
 <asp:GridView ID="gridViewAmtRequest" runat="server" AutoGenerateColumns="False"  AutoPostBack="true" CellPadding="4" GridLines="None" CssClass="auto-style1" ForeColor="#333333" OnSelectedIndexChanged="gridViewZoomLink_SelectedIndexChanged" >
                                <AlternatingRowStyle BackColor="White" />
                                <Columns>
                                    <asp:BoundField DataField="total_pending_id" HeaderText="Pending ID" />
                                    <asp:BoundField DataField="Total_Amt" HeaderText="Total Amount of Customers Requesting Consultation" />
                                    <asp:BoundField DataField="aud_dt" HeaderText="Date Entered" DataFormatString="{0:dd/MM/yyyy}" />
                            ...
                            <hr />
                              ...
                              <center><h4>Operations </h4></center>
                               <asp:Button ID="btnSetCurrent" runat="server" Text="Set Current " class="form-control" OnClick="btnSetCurrent_Click"  /><br />
                                       <asp:Button ID="btnUpdate" runat="server" Text="Update Zoom Link" class="form-control" OnClick="btnUpdate_Click" /> <br />
                                         <asp:Button ID="btnDelete" runat="server" Text="Delete Zoom Link" class="form-control" OnClick="btnDelete_Click" /><br />
                                    </div>
                                </div>
                            </div>
                        </div>
