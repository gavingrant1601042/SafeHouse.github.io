<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagePoems.aspx.cs" Inherits="SafeHouse.ManagePoems" %>
    ...
    <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup" align="center" style="display:none">  
       ...
       Poem ID:  <asp:Label ID="lblPoemIdSelected" runat="server" Text="Label" Visible="false"></asp:Label><br />
          Poem Description:  <asp:Label ID="lblPoemDescription" runat="server" Text="Label" Visible="false"></asp:Label><br /><br />
                ...
                <hr /> <h1>Set Panels</h1>
           <asp:Button ID="btnSetPoem3" runat="server" Text="Set Poem to Panel 3" class="form-control"  width="400px" OnClick="UpdatePanel3_Click" /><br />
        ...
        <hr /> <h1>Clear Panels</h1>
                   ...
                   <asp:Button ID="btnClearPanel3" runat="server" Text="Clear Panel 3" class="form-control"  width="400px"  OnClick="ClearPanel1_Click"/><br />
...
<script type="text/javascript">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Edit Poem</h3>
  ...
  <div class="form-group"> 
      <asp:GridView ID="gridViewPoems" runat="server" AutoGenerateColumns="False"  AutoPostBack="true" CellPadding="4" GridLines="None" CssClass="auto-style1" OnSelectedIndexChanged="gridViewPoems_SelectedIndexChanged" ForeColor="#333333"  EmptyDataText="No Poem  Found">
                                <AlternatingRowStyle BackColor="White" />
                                <Columns>
                                    <asp:BoundField DataField="PoemsId" HeaderText="PoemsId" />
                                    <asp:BoundField DataField="PoemTitle" HeaderText="PoemTitle" />
                                    <asp:BoundField DataField="PoemDescription" HeaderText="PoemDescription" />
...
<br />
                                <center><h4>Manage Poems</h4></center>
                                       <asp:Button ID="btnSavePoem" runat="server" Text="Save Poem" class="form-control" OnClick="btnSavePoem_Click"  /> <br />
                                         <asp:Button ID="btnDelete" runat="server" Text="Delete Poem" class="form-control" OnClick="btnDelete_Click1"  /><br />
