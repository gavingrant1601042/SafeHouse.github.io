<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPoems.aspx.cs" Inherits="SafeHouse.EditPoems" %>
                        ...
                        <div class="col-lg-7 col-xl-8">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary fw-bold m-0">Admin Procedures </h6>
                                ...
                                <div class="card-body">
                                    <div class="chart-area">  
                                        ...
                                        1.<a href="SetupZoomLink.aspx">Set-up Zoom Link</a> <br />
                                        2. <a href="TotalPendingRequest.aspx">Set-up Pending Clients Amount </a><br />
                                        3.<a href="ManagePoems.aspx">Edit Poem</a><br />
                                        4.<a href="UserSubscription.aspx">Manage Subscription</a><br />
                                        5.<a href="ManagePoemDashboard.aspx">Manage Dashboard Poem</a>
                                    </div>
                            </div>
                        </div>
