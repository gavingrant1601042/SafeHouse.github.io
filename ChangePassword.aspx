<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="SafeHouse.ChangePassword" %>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Change Password</h3>
                    </div>
                    <div class="row">
...
<br />
                                       ...
                                       <asp:Button ID="btnChangePwd" runat="server" Text="Change Password" class="form-control" OnClick="btnChangePwd_Click" />
